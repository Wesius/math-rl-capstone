...
% Logo in footer
\setbeamertemplate{frame footer}{\hfill\includegraphics[height=0.6cm]{figures/re_logo.jpg}}
...
\begin{frame}[plain]
    ...
    {\small\color{regray} Code: \url{github.com/wesgriffin/math-rl-capstone}}
\end{frame}
}
